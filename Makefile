...
bash: ## Limpar todas as bases de dados
	docker-compose exec notaservicos bash

up: ## Subindo todos os containers
	docker-compose up -d --force-recreate

supervisor: ## Re-criando container do supervisor
	docker-compose up -d --force-recreate notaservicos_supervisor

migrate: ## Migrando todas as tabelas
	docker-compose exec notaservicos php artisan migrate

fresh: ## Limpando todas as tabelas
	docker-compose exec notaservicos php artisan migrate:fresh
